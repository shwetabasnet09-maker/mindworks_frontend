        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            >
              ...
              <p className="text-xl text-white mb-12 leading-relaxed font-medium">
          ...
          <div className="grid grid-cols-1 gap-6 relative">
            ...
            {FEATURES.map((feature, idx) => (
              <motion.div
                ...
                className="glass md:p-10 rounded-[40px] group hover:border-[#00A74E] transition-all duration-500"
              >
                <div className="flex items-start space-x-6">
                  <div className="w-16 h-16  flex items-center justify-center text-[#00A74E]  group-hover:text-white transition-all duration-500">
                    <feature.icon size={32} />
                  </div>
                  <div>
                    <h3 className="text-2xl font-heading font-black text-white mb-3">{feature.title}</h3>
                    <p className="text-white text-lg leading-relaxed font-medium">{feature.description}</p>
                  </div>
                </div>
              </motion.div>
            ))}

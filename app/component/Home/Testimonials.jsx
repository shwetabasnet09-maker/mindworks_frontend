...
//               <div className="absolute bottom-[180px] left-6 right-6 flex flex-wrap gap-2 pointer-events-none">
//                 {t.tags?.map((tag, i) => (
//                   <span 
//                     key={i} 
...
//               <div className="absolute inset-0 p-10 flex flex-col justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-[#00A74E]/90 backdrop-blur-lg pointer-events-none">

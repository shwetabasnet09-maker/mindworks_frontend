      ...
      <div className="wrapper px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-end mb-24 gap-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl md:text-7xl font-black text-white leading-[1] tracking-tighter outfit">
            ...
            >
              <Link href={`/services/${service.slug}`} className="group block h-full">
                <div className="glass p-8 rounded-[40px] h-full flex flex-col hover:bg-white/[0.04] transition-all duration-500 border border-white/10 hover:border-[#00A74E]/30">
                  ...
                  <p className="text-slate-400 text-base mb-8 flex-grow font-medium">
                    {service.description}
                  </p>
